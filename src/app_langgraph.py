...
def build_graph(session):
    ...
    def analyze_kanji(state: State):
        ...
        response = structured_model.invoke(
            f"Generate the meaning and readings of this Japanese kanji: "
            f"{state['kanji']}"
        )
    ...
    def generate_lesson(state: State):
        ...
        response = model.invoke(
            ...
            Explain when these readings are used
            along with a small example conversation.
            """
        )
    ...
    def print_lesson(state: State):
        ...
        print(
            state["meaning"].to_polished_string()
        )
